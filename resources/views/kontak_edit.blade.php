            ...
            @foreach($data as $datas)
                <form action="{{ route('kontak.update', $datas->ID) }}" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="nohp" name="phoneNumber" value="{{ $datas->PhoneNumber }}">
                    </div>
                    <div class="form-group">
                        <label for="alamat">Alamat:</label>
                        <textarea class="form-control" id="alamat" name="address">{{ $datas->Address }}</textarea>
                    </div>
                    <div class="form-group">
